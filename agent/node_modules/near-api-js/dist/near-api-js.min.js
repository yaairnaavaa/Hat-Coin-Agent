...
},{"../asn1":19,"inherits":155,"vm":258}],21:[function(require,module,exports){
...
},{"es-define-property":116,"es-errors/type":122,"function-bind":127,"get-intrinsic":130,"set-function-length":231}],79:[function(require,module,exports){
...
},{"inherits":155,"safe-buffer":227,"stream":244,"string_decoder":250}],80:[function(require,module,exports){
...
},{"cipher-base":79,"inherits":155,"md5.js":163,"ripemd160":225,"sha.js":234}],83:[function(require,module,exports){
...
},{"./legacy":85,"cipher-base":79,"create-hash/md5":83,"inherits":155,"ripemd160":225,"safe-buffer":227,"sha.js":234}],85:[function(require,module,exports){
...
},{"is-property":159,"util":257}],129:[function(require,module,exports){
...
},{"depd":88,"inherits":154,"setprototypeof":232,"statuses":243,"toidentifier":253}],152:[function(require,module,exports){
...
},{"http":245,"url":254}],153:[function(require,module,exports){
...
},{"./formats":157,"generate-function":128,"generate-object-property":129,"jsonpointer":161,"xtend":259}],159:[function(require,module,exports){
...
},{"./default-encoding":177,"./precondition":178,"./to-buffer":180,"create-hash/md5":83,"ripemd160":225,"safe-buffer":227,"sha.js":234}],180:[function(require,module,exports){
...
},{"./formats":190,"./utils":194,"side-channel":241}],194:[function(require,module,exports){
...
},{"./_stream_duplex":198,"./internal/streams/BufferList":203,"./internal/streams/destroy":204,"./internal/streams/stream":205,"_process":182,"core-util-is":80,"events":124,"inherits":155,"isarray":160,"process-nextick-args":181,"safe-buffer":226,"string_decoder/":249,"util":44}],201:[function(require,module,exports){
...
},{"./_stream_duplex":198,"./internal/streams/destroy":204,"./internal/streams/stream":205,"_process":182,"core-util-is":80,"inherits":155,"process-nextick-args":181,"safe-buffer":226,"timers":251,"util-deprecate":255}],203:[function(require,module,exports){
...
},{"../errors":210,"./_stream_duplex":211,"./internal/streams/async_iterator":216,"./internal/streams/buffer_list":217,"./internal/streams/destroy":218,"./internal/streams/from":220,"./internal/streams/state":222,"./internal/streams/stream":223,"_process":182,"buffer":75,"events":124,"inherits":155,"string_decoder/":250,"util":44}],214:[function(require,module,exports){
...
},{"../errors":210,"./_stream_duplex":211,"./internal/streams/destroy":218,"./internal/streams/state":222,"./internal/streams/stream":223,"_process":182,"buffer":75,"inherits":155,"util-deprecate":255}],216:[function(require,module,exports){
(function (process){(function (){
...
},{"./lib":230,"./lib/elliptic":229}],229:[function(require,module,exports){
const EC=require("elliptic").ec,ec=new EC("secp256k1"),ecparams=ec.curve,BN=ecparams.n.constructor;function loadCompressedPublicKey(e,r){let n=new BN(r);if(n.cmp(ecparams.p)>=0)return null;let t=(n=n.toRed(ecparams.red)).redSqr().redIMul(n).redIAdd(ecparams.b).redSqrt();return 3===e!==t.isOdd()&&(t=t.redNeg()),ec.keyPair({pub:{x:n,y:t}})}function loadUncompressedPublicKey(e,r,n){let t=new BN(r),a=new BN(n);if(t.cmp(ecparams.p)>=0||a.cmp(ecparams.p)>=0)return null;if(t=t.toRed(ecparams.red),a=a.toRed(ecparams.red),(6===e||7===e)&&a.isOdd()!==(7===e))return null;const c=t.redSqr().redIMul(t);return a.redSqr().redISub(c.redIAdd(ecparams.b)).isZero()?ec.keyPair({pub:{x:t,y:a}}):null}function loadPublicKey(e){const r=e[0];switch(r){case 2:case 3:return 33!==e.length?null:loadCompressedPublicKey(r,e.subarray(1,33));case 4:case 6:case 7:return 65!==e.length?null:loadUncompressedPublicKey(r,e.subarray(1,33),e.subarray(33,65));default:return null}}function savePublicKey(e,r){const n=r.encode(null,33===e.length);for(let r=0;r<e.length;++r)e[r]=n[r]}module.exports={contextRandomize:()=>0,privateKeyVerify(e){const r=new BN(e);return r.cmp(ecparams.n)<0&&!r.isZero()?0:1},privateKeyNegate(e){const r=new BN(e),n=ecparams.n.sub(r).umod(ecparams.n).toArrayLike(Uint8Array,"be",32);return e.set(n),0},privateKeyTweakAdd(e,r){const n=new BN(r);if(n.cmp(ecparams.n)>=0)return 1;if(n.iadd(new BN(e)),n.cmp(ecparams.n)>=0&&n.isub(ecparams.n),n.isZero())return 1;const t=n.toArrayLike(Uint8Array,"be",32);return e.set(t),0},privateKeyTweakMul(e,r){let n=new BN(r);if(n.cmp(ecparams.n)>=0||n.isZero())return 1;n.imul(new BN(e)),n.cmp(ecparams.n)>=0&&(n=n.umod(ecparams.n));const t=n.toArrayLike(Uint8Array,"be",32);return e.set(t),0},publicKeyVerify:e=>null===loadPublicKey(e)?1:0,publicKeyCreate(e,r){const n=new BN(r);return n.cmp(ecparams.n)>=0||n.isZero()?1:(savePublicKey(e,ec.keyFromPrivate(r).getPublic()),0)},publicKeyConvert(e,r){const n=loadPublicKey(r);return null===n?1:(savePublicKey(e,n.getPublic()),0)},publicKeyNegate(e,r){const n=loadPublicKey(r);if(null===n)return 1;const t=n.getPublic();return t.y=t.y.redNeg(),savePublicKey(e,t),0},publicKeyCombine(e,r){const n=new Array(r.length);for(let e=0;e<r.length;++e)if(n[e]=loadPublicKey(r[e]),null===n[e])return 1;let t=n[0].getPublic();for(let e=1;e<n.length;++e)t=t.add(n[e].pub);return t.isInfinity()?2:(savePublicKey(e,t),0)},publicKeyTweakAdd(e,r,n){const t=loadPublicKey(r);if(null===t)return 1;if((n=new BN(n)).cmp(ecparams.n)>=0)return 2;const a=t.getPublic().add(ecparams.g.mul(n));return a.isInfinity()?2:(savePublicKey(e,a),0)},publicKeyTweakMul(e,r,n){const t=loadPublicKey(r);return null===t?1:(n=new BN(n)).cmp(ecparams.n)>=0||n.isZero()?2:(savePublicKey(e,t.getPublic().mul(n)),0)},signatureNormalize(e){const r=new BN(e.subarray(0,32)),n=new BN(e.subarray(32,64));return r.cmp(ecparams.n)>=0||n.cmp(ecparams.n)>=0?1:(1===n.cmp(ec.nh)&&e.set(ecparams.n.sub(n).toArrayLike(Uint8Array,"be",32),32),0)},signatureExport(e,r){const n=r.subarray(0,32),t=r.subarray(32,64);if(new BN(n).cmp(ecparams.n)>=0)return 1;if(new BN(t).cmp(ecparams.n)>=0)return 1;const{output:a}=e;let c=a.subarray(4,37);c[0]=0,c.set(n,1);let u=33,s=0;for(;u>1&&0===c[s]&&!(128&c[s+1]);--u,++s);if(128&(c=c.subarray(s))[0])return 1;if(u>1&&0===c[0]&&!(128&c[1]))return 1;let i=a.subarray(39,72);i[0]=0,i.set(t,1);let l=33,o=0;for(;l>1&&0===i[o]&&!(128&i[o+1]);--l,++o);return 128&(i=i.subarray(o))[0]?1:l>1&&0===i[0]&&!(128&i[1])?1:(e.outputlen=6+u+l,a[0]=48,a[1]=e.outputlen-2,a[2]=2,a[3]=c.length,a.set(c,4),a[4+u]=2,a[5+u]=i.length,a.set(i,6+u),0)},signatureImport(e,r){if(r.length<8)return 1;if(r.length>72)return 1;if(48!==r[0])return 1;if(r[1]!==r.length-2)return 1;if(2!==r[2])return 1;const n=r[3];if(0===n)return 1;if(5+n>=r.length)return 1;if(2!==r[4+n])return 1;const t=r[5+n];if(0===t)return 1;if(6+n+t!==r.length)return 1;if(128&r[4])return 1;if(n>1&&0===r[4]&&!(128&r[5]))return 1;if(128&r[n+6])return 1;if(t>1&&0===r[n+6]&&!(128&r[n+7]))return 1;let a=r.subarray(4,4+n);if(33===a.length&&0===a[0]&&(a=a.subarray(1)),a.length>32)return 1;let c=r.subarray(6+n);if(33===c.length&&0===c[0]&&(c=c.slice(1)),c.length>32)throw new Error("S length is too long");let u=new BN(a);u.cmp(ecparams.n)>=0&&(u=new BN(0));let s=new BN(r.subarray(6+n));return s.cmp(ecparams.n)>=0&&(s=new BN(0)),e.set(u.toArrayLike(Uint8Array,"be",32),0),e.set(s.toArrayLike(Uint8Array,"be",32),32),0},ecdsaSign(e,r,n,t,a){if(a){const e=a;a=(a=>{const c=e(r,n,null,t,a);if(!(c instanceof Uint8Array&&32===c.length))throw new Error("This is the way");return new BN(c)})}const c=new BN(n);if(c.cmp(ecparams.n)>=0||c.isZero())return 1;let u;try{u=ec.sign(r,n,{canonical:!0,k:a,pers:t})}catch(e){return 1}return e.signature.set(u.r.toArrayLike(Uint8Array,"be",32),0),e.signature.set(u.s.toArrayLike(Uint8Array,"be",32),32),e.recid=u.recoveryParam,0},ecdsaVerify(e,r,n){const t={r:e.subarray(0,32),s:e.subarray(32,64)},a=new BN(t.r),c=new BN(t.s);if(a.cmp(ecparams.n)>=0||c.cmp(ecparams.n)>=0)return 1;if(1===c.cmp(ec.nh)||a.isZero()||c.isZero())return 3;const u=loadPublicKey(n);if(null===u)return 2;const s=u.getPublic();return ec.verify(r,t,s)?0:3},ecdsaRecover(e,r,n,t){const a={r:r.slice(0,32),s:r.slice(32,64)},c=new BN(a.r),u=new BN(a.s);if(c.cmp(ecparams.n)>=0||u.cmp(ecparams.n)>=0)return 1;if(c.isZero()||u.isZero())return 2;let s;try{s=ec.recoverPubKey(t,a,n)}catch(e){return 2}return savePublicKey(e,s),0},ecdh(e,r,n,t,a,c,u){const s=loadPublicKey(r);if(null===s)return 1;const i=new BN(n);if(i.cmp(ecparams.n)>=0||i.isZero())return 2;const l=s.getPublic().mul(i);if(void 0===a){const r=l.encode(null,!0),n=ec.hash().update(r).digest();for(let r=0;r<32;++r)e[r]=n[r]}else{c||(c=new Uint8Array(32));const r=l.getX().toArray("be",32);for(let e=0;e<32;++e)c[e]=r[e];u||(u=new Uint8Array(32));const n=l.getY().toArray("be",32);for(let e=0;e<32;++e)u[e]=n[e];const s=a(c,u,t);if(!(s instanceof Uint8Array&&s.length===e.length))return 2;e.set(s)}return 0}};

},{"elliptic":100}],230:[function(require,module,exports){
const errors={IMPOSSIBLE_CASE:"Impossible case. Please create issue.",TWEAK_ADD:"The tweak was out of range or the resulted private key is invalid",TWEAK_MUL:"The tweak was out of range or equal to zero",CONTEXT_RANDOMIZE_UNKNOW:"Unknow error on context randomization",SECKEY_INVALID:"Private Key is invalid",PUBKEY_PARSE:"Public Key could not be parsed",PUBKEY_SERIALIZE:"Public Key serialization error",PUBKEY_COMBINE:"The sum of the public keys is not valid",SIG_PARSE:"Signature could not be parsed",SIGN:"The nonce generation function failed, or the private key was invalid",RECOVER:"Public key could not be recover",ECDH:"Scalar was invalid (zero or overflow)"};function assert(r,e){if(!r)throw new Error(e)}function isUint8Array(r,e,t){if(assert(e instanceof Uint8Array,`Expected ${r} to be an Uint8Array`),void 0!==t)if(Array.isArray(t)){const s=`Expected ${r} to be an Uint8Array with length [${t.join(", ")}]`;assert(t.includes(e.length),s)}else{const s=`Expected ${r} to be an Uint8Array with length ${t}`;assert(e.length===t,s)}}function isCompressed(r){assert("Boolean"===toTypeString(r),"Expected compressed to be a Boolean")}function getAssertedOutput(r=(r=>new Uint8Array(r)),e){return"function"==typeof r&&(r=r(e)),isUint8Array("output",r,e),r}function toTypeString(r){return Object.prototype.toString.call(r).slice(8,-1)}module.exports=(r=>({contextRandomize(e){switch(assert(null===e||e instanceof Uint8Array,"Expected seed to be an Uint8Array or null"),null!==e&&isUint8Array("seed",e,32),r.contextRandomize(e)){case 1:throw new Error(errors.CONTEXT_RANDOMIZE_UNKNOW)}},privateKeyVerify:e=>(isUint8Array("private key",e,32),0===r.privateKeyVerify(e)),privateKeyNegate(e){switch(isUint8Array("private key",e,32),r.privateKeyNegate(e)){case 0:return e;case 1:throw new Error(errors.IMPOSSIBLE_CASE)}},privateKeyTweakAdd(e,t){switch(isUint8Array("private key",e,32),isUint8Array("tweak",t,32),r.privateKeyTweakAdd(e,t)){case 0:return e;case 1:throw new Error(errors.TWEAK_ADD)}},privateKeyTweakMul(e,t){switch(isUint8Array("private key",e,32),isUint8Array("tweak",t,32),r.privateKeyTweakMul(e,t)){case 0:return e;case 1:throw new Error(errors.TWEAK_MUL)}},publicKeyVerify:e=>(isUint8Array("public key",e,[33,65]),0===r.publicKeyVerify(e)),publicKeyCreate(e,t=!0,s){switch(isUint8Array("private key",e,32),isCompressed(t),s=getAssertedOutput(s,t?33:65),r.publicKeyCreate(s,e)){case 0:return s;case 1:throw new Error(errors.SECKEY_INVALID);case 2:throw new Error(errors.PUBKEY_SERIALIZE)}},publicKeyConvert(e,t=!0,s){switch(isUint8Array("public key",e,[33,65]),isCompressed(t),s=getAssertedOutput(s,t?33:65),r.publicKeyConvert(s,e)){case 0:return s;case 1:throw new Error(errors.PUBKEY_PARSE);case 2:throw new Error(errors.PUBKEY_SERIALIZE)}},publicKeyNegate(e,t=!0,s){switch(isUint8Array("public key",e,[33,65]),isCompressed(t),s=getAssertedOutput(s,t?33:65),r.publicKeyNegate(s,e)){case 0:return s;case 1:throw new Error(errors.PUBKEY_PARSE);case 2:throw new Error(errors.IMPOSSIBLE_CASE);case 3:throw new Error(errors.PUBKEY_SERIALIZE)}},publicKeyCombine(e,t=!0,s){assert(Array.isArray(e),"Expected public keys to be an Array"),assert(e.length>0,"Expected public keys array will have more than zero items");for(const r of e)isUint8Array("public key",r,[33,65]);switch(isCompressed(t),s=getAssertedOutput(s,t?33:65),r.publicKeyCombine(s,e)){case 0:return s;case 1:throw new Error(errors.PUBKEY_PARSE);case 2:throw new Error(errors.PUBKEY_COMBINE);case 3:throw new Error(errors.PUBKEY_SERIALIZE)}},publicKeyTweakAdd(e,t,s=!0,i){switch(isUint8Array("public key",e,[33,65]),isUint8Array("tweak",t,32),isCompressed(s),i=getAssertedOutput(i,s?33:65),r.publicKeyTweakAdd(i,e,t)){case 0:return i;case 1:throw new Error(errors.PUBKEY_PARSE);case 2:throw new Error(errors.TWEAK_ADD)}},publicKeyTweakMul(e,t,s=!0,i){switch(isUint8Array("public key",e,[33,65]),isUint8Array("tweak",t,32),isCompressed(s),i=getAssertedOutput(i,s?33:65),r.publicKeyTweakMul(i,e,t)){case 0:return i;case 1:throw new Error(errors.PUBKEY_PARSE);case 2:throw new Error(errors.TWEAK_MUL)}},signatureNormalize(e){switch(isUint8Array("signature",e,64),r.signatureNormalize(e)){case 0:return e;case 1:throw new Error(errors.SIG_PARSE)}},signatureExport(e,t){isUint8Array("signature",e,64);const s={output:t=getAssertedOutput(t,72),outputlen:72};switch(r.signatureExport(s,e)){case 0:return t.slice(0,s.outputlen);case 1:throw new Error(errors.SIG_PARSE);case 2:throw new Error(errors.IMPOSSIBLE_CASE)}},signatureImport(e,t){switch(isUint8Array("signature",e),t=getAssertedOutput(t,64),r.signatureImport(t,e)){case 0:return t;case 1:throw new Error(errors.SIG_PARSE);case 2:throw new Error(errors.IMPOSSIBLE_CASE)}},ecdsaSign(e,t,s={},i){isUint8Array("message",e,32),isUint8Array("private key",t,32),assert("Object"===toTypeString(s),"Expected options to be an Object"),void 0!==s.data&&isUint8Array("options.data",s.data),void 0!==s.noncefn&&assert("Function"===toTypeString(s.noncefn),"Expected options.noncefn to be a Function");const o={signature:i=getAssertedOutput(i,64),recid:null};switch(r.ecdsaSign(o,e,t,s.data,s.noncefn)){case 0:return o;case 1:throw new Error(errors.SIGN);case 2:throw new Error(errors.IMPOSSIBLE_CASE)}},ecdsaVerify(e,t,s){switch(isUint8Array("signature",e,64),isUint8Array("message",t,32),isUint8Array("public key",s,[33,65]),r.ecdsaVerify(e,t,s)){case 0:return!0;case 3:return!1;case 1:throw new Error(errors.SIG_PARSE);case 2:throw new Error(errors.PUBKEY_PARSE)}},ecdsaRecover(e,t,s,i=!0,o){switch(isUint8Array("signature",e,64),assert("Number"===toTypeString(t)&&t>=0&&t<=3,"Expected recovery id to be a Number within interval [0, 3]"),isUint8Array("message",s,32),isCompressed(i),o=getAssertedOutput(o,i?33:65),r.ecdsaRecover(o,e,t,s)){case 0:return o;case 1:throw new Error(errors.SIG_PARSE);case 2:throw new Error(errors.RECOVER);case 3:throw new Error(errors.IMPOSSIBLE_CASE)}},ecdh(e,t,s={},i){switch(isUint8Array("public key",e,[33,65]),isUint8Array("private key",t,32),assert("Object"===toTypeString(s),"Expected options to be an Object"),void 0!==s.data&&isUint8Array("options.data",s.data),void 0!==s.hashfn?(assert("Function"===toTypeString(s.hashfn),"Expected options.hashfn to be a Function"),void 0!==s.xbuf&&isUint8Array("options.xbuf",s.xbuf,32),void 0!==s.ybuf&&isUint8Array("options.ybuf",s.ybuf,32),isUint8Array("output",i)):i=getAssertedOutput(i,32),r.ecdh(i,e,t,s.data,s.hashfn,s.xbuf,s.ybuf)){case 0:return i;case 1:throw new Error(errors.PUBKEY_PARSE);case 2:throw new Error(errors.ECDH)}}}));
...
},{"define-data-property":87,"es-errors/type":122,"get-intrinsic":130,"gopd":131,"has-property-descriptors":132}],232:[function(require,module,exports){
...
},{"./hash":233,"inherits":155,"safe-buffer":227}],236:[function(require,module,exports){
...
},{"./hash":233,"inherits":155,"safe-buffer":227}],237:[function(require,module,exports){
...
},{"./hash":233,"./sha256":238,"inherits":155,"safe-buffer":227}],238:[function(require,module,exports){
...
},{"./hash":233,"inherits":155,"safe-buffer":227}],239:[function(require,module,exports){
...
},{"./hash":233,"./sha512":240,"inherits":155,"safe-buffer":227}],240:[function(require,module,exports){
...
},{"./hash":233,"inherits":155,"safe-buffer":227}],241:[function(require,module,exports){
...
},{"call-bind/callBound":77,"es-errors/type":122,"get-intrinsic":130,"object-inspect":169}],242:[function(require,module,exports){
module.exports={
  "100": "Continue",
...
},{"./codes.json":242}],244:[function(require,module,exports){
...
},{"events":124,"inherits":155,"readable-stream/duplex.js":197,"readable-stream/passthrough.js":206,"readable-stream/readable.js":207,"readable-stream/transform.js":208,"readable-stream/writable.js":209}],245:[function(require,module,exports){
(function (global){(function (){
...
},{"./lib/request":247,"./lib/response":248,"builtin-status-codes":76,"url":254,"xtend":259}],246:[function(require,module,exports){
(function (global){(function (){
...
},{"./capability":246,"./response":248,"_process":182,"buffer":75,"inherits":155,"readable-stream":207,"to-arraybuffer":252}],248:[function(require,module,exports){
(function (process,global,Buffer){(function (){
...
},{"./capability":246,"_process":182,"buffer":75,"inherits":155,"readable-stream":207}],249:[function(require,module,exports){
...
},{"safe-buffer":226}],250:[function(require,module,exports){
"use strict";var Buffer=require("safe-buffer").Buffer,isEncoding=Buffer.isEncoding||function(t){switch((t=""+t)&&t.toLowerCase()){case"hex":case"utf8":case"utf-8":case"ascii":case"binary":case"base64":case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":case"raw":return!0;default:return!1}};function _normalizeEncoding(t){if(!t)return"utf8";for(var e;;)switch(t){case"utf8":case"utf-8":return"utf8";case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return"utf16le";case"latin1":case"binary":return"latin1";case"base64":case"ascii":case"hex":return t;default:if(e)return;t=(""+t).toLowerCase(),e=!0}}function normalizeEncoding(t){var e=_normalizeEncoding(t);if("string"!=typeof e&&(Buffer.isEncoding===isEncoding||!isEncoding(t)))throw new Error("Unknown encoding: "+t);return e||t}function StringDecoder(t){var e;switch(this.encoding=normalizeEncoding(t),this.encoding){case"utf16le":this.text=utf16Text,this.end=utf16End,e=4;break;case"utf8":this.fillLast=utf8FillLast,e=4;break;case"base64":this.text=base64Text,this.end=base64End,e=3;break;default:return this.write=simpleWrite,void(this.end=simpleEnd)}this.lastNeed=0,this.lastTotal=0,this.lastChar=Buffer.allocUnsafe(e)}function utf8CheckByte(t){return t<=127?0:t>>5==6?2:t>>4==14?3:t>>3==30?4:t>>6==2?-1:-2}function utf8CheckIncomplete(t,e,s){var i=e.length-1;if(i<s)return 0;var n=utf8CheckByte(e[i]);return n>=0?(n>0&&(t.lastNeed=n-1),n):--i<s||-2===n?0:(n=utf8CheckByte(e[i]))>=0?(n>0&&(t.lastNeed=n-2),n):--i<s||-2===n?0:(n=utf8CheckByte(e[i]))>=0?(n>0&&(2===n?n=0:t.lastNeed=n-3),n):0}function utf8CheckExtraBytes(t,e,s){if(128!=(192&e[0]))return t.lastNeed=0,"�";if(t.lastNeed>1&&e.length>1){if(128!=(192&e[1]))return t.lastNeed=1,"�";if(t.lastNeed>2&&e.length>2&&128!=(192&e[2]))return t.lastNeed=2,"�"}}function utf8FillLast(t){var e=this.lastTotal-this.lastNeed,s=utf8CheckExtraBytes(this,t,e);return void 0!==s?s:this.lastNeed<=t.length?(t.copy(this.lastChar,e,0,this.lastNeed),this.lastChar.toString(this.encoding,0,this.lastTotal)):(t.copy(this.lastChar,e,0,t.length),void(this.lastNeed-=t.length))}function utf8Text(t,e){var s=utf8CheckIncomplete(this,t,e);if(!this.lastNeed)return t.toString("utf8",e);this.lastTotal=s;var i=t.length-(s-this.lastNeed);return t.copy(this.lastChar,0,i),t.toString("utf8",e,i)}function utf8End(t){var e=t&&t.length?this.write(t):"";return this.lastNeed?e+"�":e}function utf16Text(t,e){if((t.length-e)%2==0){var s=t.toString("utf16le",e);if(s){var i=s.charCodeAt(s.length-1);if(i>=55296&&i<=56319)return this.lastNeed=2,this.lastTotal=4,this.lastChar[0]=t[t.length-2],this.lastChar[1]=t[t.length-1],s.slice(0,-1)}return s}return this.lastNeed=1,this.lastTotal=2,this.lastChar[0]=t[t.length-1],t.toString("utf16le",e,t.length-1)}function utf16End(t){var e=t&&t.length?this.write(t):"";if(this.lastNeed){var s=this.lastTotal-this.lastNeed;return e+this.lastChar.toString("utf16le",0,s)}return e}function base64Text(t,e){var s=(t.length-e)%3;return 0===s?t.toString("base64",e):(this.lastNeed=3-s,this.lastTotal=3,1===s?this.lastChar[0]=t[t.length-1]:(this.lastChar[0]=t[t.length-2],this.lastChar[1]=t[t.length-1]),t.toString("base64",e,t.length-s))}function base64End(t){var e=t&&t.length?this.write(t):"";return this.lastNeed?e+this.lastChar.toString("base64",0,3-this.lastNeed):e}function simpleWrite(t){return t.toString(this.encoding)}function simpleEnd(t){return t&&t.length?this.write(t):""}exports.StringDecoder=StringDecoder,StringDecoder.prototype.write=function(t){if(0===t.length)return"";var e,s;if(this.lastNeed){if(void 0===(e=this.fillLast(t)))return"";s=this.lastNeed,this.lastNeed=0}else s=0;return s<t.length?e?e+this.text(t,s):this.text(t,s):e||""},StringDecoder.prototype.end=utf8End,StringDecoder.prototype.text=utf8Text,StringDecoder.prototype.fillLast=function(t){if(this.lastNeed<=t.length)return t.copy(this.lastChar,this.lastTotal-this.lastNeed,0,this.lastNeed),this.lastChar.toString(this.encoding,0,this.lastTotal);t.copy(this.lastChar,this.lastTotal-this.lastNeed,0,t.length),this.lastNeed-=t.length};

},{"safe-buffer":227}],251:[function(require,module,exports){
...
},{"process/browser.js":182,"timers":251}],252:[function(require,module,exports){
...
},{"buffer":75}],253:[function(require,module,exports){
...
},{"punycode/":189,"qs":191}],255:[function(require,module,exports){
(function (global){(function (){
...
},{"./support/isBuffer":256,"_process":182,"inherits":154}],258:[function(require,module,exports){
...
},{"./utils":273,"@near-js/crypto":275,"@near-js/providers":325,"@near-js/transactions":335,"@near-js/types":342,"@near-js/utils":353,"buffer":75}],261:[function(require,module,exports){
(function (Buffer){(function (){
...
},{"./account_multisig":263,"./constants":265,"./types":272,"@near-js/crypto":275,"@near-js/providers":325,"@near-js/transactions":335,"@near-js/types":342,"@near-js/utils":353,"buffer":75}],262:[function(require,module,exports){
...
},{"@near-js/providers":325}],263:[function(require,module,exports){
(function (Buffer){(function (){
...
},{"./account":260,"./constants":265,"./types":272,"@near-js/transactions":335,"@near-js/utils":353,"buffer":75}],264:[function(require,module,exports){
...
},{"@near-js/providers":325,"@near-js/signers":329}],265:[function(require,module,exports){
...
},{"@near-js/utils":353}],266:[function(require,module,exports){
...
},{"./account":260,"./errors":267,"./local-view-execution":269,"./utils":273,"@near-js/types":342,"@near-js/utils":353,"depd":89,"is-my-json-valid":158,"near-abi":168}],267:[function(require,module,exports){
...
},{"./account":260,"./account_2fa":261,"./account_creator":262,"./account_multisig":263,"./connection":264,"./constants":265,"./contract":266,"./errors":267,"./types":272}],269:[function(require,module,exports){
(function (Buffer){(function (){
...
},{"../utils":273,"./runtime":270,"./storage":271,"@near-js/utils":353,"buffer":75}],270:[function(require,module,exports){
(function (Buffer){(function (){
...
},{"buffer":75,"crypto":86}],271:[function(require,module,exports){
...
},{"lru_map":162}],272:[function(require,module,exports){
...
},{"@near-js/types":342,"@near-js/utils":353,"buffer":75}],274:[function(require,module,exports){
"use strict";var KeyType,KeySize;Object.defineProperty(exports,"__esModule",{value:!0}),exports.KeySize=exports.KeyType=void 0,function(e){e[e.ED25519=0]="ED25519",e[e.SECP256K1=1]="SECP256K1"}(KeyType=exports.KeyType||(exports.KeyType={})),function(e){e[e.SECRET_KEY=32]="SECRET_KEY",e[e.ED25519_PUBLIC_KEY=32]="ED25519_PUBLIC_KEY",e[e.SECP256k1_PUBLIC_KEY=64]="SECP256k1_PUBLIC_KEY"}(KeySize=exports.KeySize||(exports.KeySize={}));

},{}],275:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.PublicKey=exports.KeyPairSecp256k1=exports.KeyPairEd25519=exports.KeyPair=exports.KeyType=void 0;var constants_1=require("./constants");Object.defineProperty(exports,"KeyType",{enumerable:!0,get:function(){return constants_1.KeyType}});var key_pair_1=require("./key_pair");Object.defineProperty(exports,"KeyPair",{enumerable:!0,get:function(){return key_pair_1.KeyPair}});var key_pair_ed25519_1=require("./key_pair_ed25519");Object.defineProperty(exports,"KeyPairEd25519",{enumerable:!0,get:function(){return key_pair_ed25519_1.KeyPairEd25519}});var key_pair_secp256k1_1=require("./key_pair_secp256k1");Object.defineProperty(exports,"KeyPairSecp256k1",{enumerable:!0,get:function(){return key_pair_secp256k1_1.KeyPairSecp256k1}});var public_key_1=require("./public_key");Object.defineProperty(exports,"PublicKey",{enumerable:!0,get:function(){return public_key_1.PublicKey}});

},{"./constants":274,"./key_pair":276,"./key_pair_ed25519":278,"./key_pair_secp256k1":279,"./public_key":280}],276:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.KeyPair=void 0;const key_pair_base_1=require("./key_pair_base"),key_pair_ed25519_1=require("./key_pair_ed25519"),key_pair_secp256k1_1=require("./key_pair_secp256k1");class KeyPair extends key_pair_base_1.KeyPairBase{static fromRandom(e){switch(e.toUpperCase()){case"ED25519":return key_pair_ed25519_1.KeyPairEd25519.fromRandom();case"SECP256K1":return key_pair_secp256k1_1.KeyPairSecp256k1.fromRandom();default:throw new Error(`Unknown curve ${e}`)}}static fromString(e){const r=e.split(":");if(2!==r.length)throw new Error("Invalid encoded key format, must be <curve>:<encoded key>");switch(r[0].toUpperCase()){case"ED25519":return new key_pair_ed25519_1.KeyPairEd25519(r[1]);case"SECP256K1":return new key_pair_secp256k1_1.KeyPairSecp256k1(r[1]);default:throw new Error(`Unknown curve: ${r[0]}`)}}}exports.KeyPair=KeyPair;

},{"./key_pair_base":277,"./key_pair_ed25519":278,"./key_pair_secp256k1":279}],277:[function(require,module,exports){
...
},{"./constants":274,"./key_pair_base":277,"./public_key":280,"@near-js/utils":353,"@noble/curves/ed25519":7,"randombytes":195}],279:[function(require,module,exports){
"use strict";var __importDefault=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0}),exports.KeyPairSecp256k1=void 0;const constants_1=require("./constants"),key_pair_base_1=require("./key_pair_base"),public_key_1=require("./public_key"),secp256k1_1=__importDefault(require("secp256k1")),randombytes_1=__importDefault(require("randombytes")),utils_1=require("@near-js/utils");class KeyPairSecp256k1 extends key_pair_base_1.KeyPairBase{constructor(e){super();const t=(0,utils_1.baseDecode)(e),r=new Uint8Array(t.slice(0,constants_1.KeySize.SECRET_KEY)),s=secp256k1_1.default.publicKeyCreate(new Uint8Array(r),!1),i=s.subarray(1,s.length);this.publicKey=new public_key_1.PublicKey({keyType:constants_1.KeyType.SECP256K1,data:i}),this.secretKey=(0,utils_1.baseEncode)(r),this.extendedSecretKey=e}static fromRandom(){const e=(0,randombytes_1.default)(constants_1.KeySize.SECRET_KEY),t=secp256k1_1.default.publicKeyCreate(new Uint8Array(e),!1),r=t.subarray(1,t.length),s=new Uint8Array([...e,...r]);return new KeyPairSecp256k1((0,utils_1.baseEncode)(s))}sign(e){const{signature:t,recid:r}=secp256k1_1.default.ecdsaSign(e,(0,utils_1.baseDecode)(this.secretKey));return{signature:new Uint8Array([...t,r]),publicKey:this.publicKey}}verify(e,t){return this.publicKey.verify(e,t)}toString(){return`secp256k1:${this.extendedSecretKey}`}getPublicKey(){return this.publicKey}}exports.KeyPairSecp256k1=KeyPairSecp256k1;

},{"./constants":274,"./key_pair_base":277,"./public_key":280,"@near-js/utils":353,"randombytes":195,"secp256k1":228}],280:[function(require,module,exports){
"use strict";var __importDefault=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0}),exports.PublicKey=void 0;const utils_1=require("@near-js/utils"),ed25519_1=require("@noble/curves/ed25519"),secp256k1_1=__importDefault(require("secp256k1")),constants_1=require("./constants"),types_1=require("@near-js/types");function key_type_to_str(e){switch(e){case constants_1.KeyType.ED25519:return"ed25519";case constants_1.KeyType.SECP256K1:return"secp256k1";default:throw new Error(`Unknown key type ${e}`)}}function str_to_key_type(e){switch(e.toLowerCase()){case"ed25519":return constants_1.KeyType.ED25519;case"secp256k1":return constants_1.KeyType.SECP256K1;default:throw new Error(`Unknown key type ${e}`)}}class ED25519PublicKey extends types_1.Assignable{constructor(){super(...arguments),this.keyType=constants_1.KeyType.ED25519}}class SECP256K1PublicKey extends types_1.Assignable{constructor(){super(...arguments),this.keyType=constants_1.KeyType.SECP256K1}}class PublicKey extends types_1.Assignable{constructor({keyType:e,data:t}){super({}),e===constants_1.KeyType.ED25519?this.ed25519Key={keyType:e,data:t}:e===constants_1.KeyType.SECP256K1&&(this.secp256k1Key={keyType:e,data:t})}static from(e){return"string"==typeof e?PublicKey.fromString(e):e}static fromString(e){const t=e.split(":");let s,n;if(1===t.length)s=t[0];else{if(2!==t.length)throw new Error("Invalid encoded key format, must be <curve>:<encoded key>");s=t[1],n=str_to_key_type(t[0])}const r=(0,utils_1.baseDecode)(s);n||(n=r.length===constants_1.KeySize.SECP256k1_PUBLIC_KEY?constants_1.KeyType.SECP256K1:constants_1.KeyType.ED25519);const y=n===constants_1.KeyType.ED25519?constants_1.KeySize.ED25519_PUBLIC_KEY:constants_1.KeySize.SECP256k1_PUBLIC_KEY;if(r.length!==y)throw new Error(`Invalid public key size (${r.length}), must be ${y}`);return new PublicKey({keyType:n,data:r})}toString(){const e=(0,utils_1.baseEncode)(this.data);return`${key_type_to_str(this.keyType)}:${e}`}verify(e,t){const s=this.keyType,n=this.data;switch(s){case constants_1.KeyType.ED25519:return ed25519_1.ed25519.verify(t,e,n);case constants_1.KeyType.SECP256K1:return secp256k1_1.default.ecdsaVerify(t.subarray(0,64),e,new Uint8Array([4,...n]));default:throw new Error(`Unknown key type: ${s}`)}}get keyPair(){return this.ed25519Key||this.secp256k1Key}get keyType(){return this.keyPair.keyType}get data(){return this.keyPair.data}}exports.PublicKey=PublicKey;

},{"./constants":274,"@near-js/types":342,"@near-js/utils":353,"@noble/curves/ed25519":7,"secp256k1":228}],281:[function(require,module,exports){
...
},{"@near-js/crypto":275,"@near-js/keystores":285}],282:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.MultiContractBrowserLocalStorageKeyStore=exports.BrowserLocalStorageKeyStore=void 0;var browser_local_storage_key_store_1=require("./browser_local_storage_key_store");Object.defineProperty(exports,"BrowserLocalStorageKeyStore",{enumerable:!0,get:function(){return browser_local_storage_key_store_1.BrowserLocalStorageKeyStore}});var multi_contract_browser_local_storage_key_store_1=require("./multi_contract_browser_local_storage_key_store");Object.defineProperty(exports,"MultiContractBrowserLocalStorageKeyStore",{enumerable:!0,get:function(){return multi_contract_browser_local_storage_key_store_1.MultiContractBrowserLocalStorageKeyStore}});

},{"./browser_local_storage_key_store":281,"./multi_contract_browser_local_storage_key_store":283}],283:[function(require,module,exports){
"use strict";var __awaiter=this&&this.__awaiter||function(t,e,r,o){return new(r||(r=Promise))(function(s,i){function n(t){try{c(o.next(t))}catch(t){i(t)}}function a(t){try{c(o.throw(t))}catch(t){i(t)}}function c(t){var e;t.done?s(t.value):(e=t.value,e instanceof r?e:new r(function(t){t(e)})).then(n,a)}c((o=o.apply(t,e||[])).next())})};Object.defineProperty(exports,"__esModule",{value:!0}),exports.MultiContractBrowserLocalStorageKeyStore=void 0;const crypto_1=require("@near-js/crypto"),keystores_1=require("@near-js/keystores"),LOCAL_STORAGE_KEY_PREFIX="near-api-js:keystore:";class MultiContractBrowserLocalStorageKeyStore extends keystores_1.MultiContractKeyStore{constructor(t=window.localStorage,e=LOCAL_STORAGE_KEY_PREFIX){super(),this.localStorage=t,this.prefix=e||LOCAL_STORAGE_KEY_PREFIX}setKey(t,e,r,o){return __awaiter(this,void 0,void 0,function*(){this.localStorage.setItem(this.storageKeyForSecretKey(t,e,o),r.toString())})}getKey(t,e,r){return __awaiter(this,void 0,void 0,function*(){const o=this.localStorage.getItem(this.storageKeyForSecretKey(t,e,r));return o?crypto_1.KeyPair.fromString(o):null})}removeKey(t,e,r){return __awaiter(this,void 0,void 0,function*(){this.localStorage.removeItem(this.storageKeyForSecretKey(t,e,r))})}clear(){return __awaiter(this,void 0,void 0,function*(){for(const t of this.storageKeys())t.startsWith(this.prefix)&&this.localStorage.removeItem(t)})}getNetworks(){return __awaiter(this,void 0,void 0,function*(){const t=new Set;for(const e of this.storageKeys())if(e.startsWith(this.prefix)){const r=e.substring(this.prefix.length).split(":");t.add(r[1])}return Array.from(t.values())})}getAccounts(t){return __awaiter(this,void 0,void 0,function*(){const e=[];for(const r of this.storageKeys())if(r.startsWith(this.prefix)){const o=r.substring(this.prefix.length).split(":");o[1]===t&&e.push(o[0])}return e})}getContracts(t,e){return __awaiter(this,void 0,void 0,function*(){const r=[];for(const o of this.storageKeys())if(o.startsWith(this.prefix)){const s=o.substring(this.prefix.length).split(":");s[1]===t&&s[0]===e&&r.push(s[2])}return r})}storageKeyForSecretKey(t,e,r){return`${this.prefix}${e}:${t}:${r}`}*storageKeys(){for(let t=0;t<this.localStorage.length;t++)yield this.localStorage.key(t)}}exports.MultiContractBrowserLocalStorageKeyStore=MultiContractBrowserLocalStorageKeyStore;

},{"@near-js/crypto":275,"@near-js/keystores":285}],284:[function(require,module,exports){
...
},{"./keystore":286,"@near-js/crypto":275}],285:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.MultiContractKeyStore=exports.MergeKeyStore=exports.KeyStore=exports.InMemoryKeyStore=void 0;var in_memory_key_store_1=require("./in_memory_key_store");Object.defineProperty(exports,"InMemoryKeyStore",{enumerable:!0,get:function(){return in_memory_key_store_1.InMemoryKeyStore}});var keystore_1=require("./keystore");Object.defineProperty(exports,"KeyStore",{enumerable:!0,get:function(){return keystore_1.KeyStore}});var merge_key_store_1=require("./merge_key_store");Object.defineProperty(exports,"MergeKeyStore",{enumerable:!0,get:function(){return merge_key_store_1.MergeKeyStore}});var multi_contract_keystore_1=require("./multi_contract_keystore");Object.defineProperty(exports,"MultiContractKeyStore",{enumerable:!0,get:function(){return multi_contract_keystore_1.MultiContractKeyStore}});

},{"./in_memory_key_store":284,"./keystore":286,"./merge_key_store":287,"./multi_contract_keystore":288}],286:[function(require,module,exports){
...
},{"./keystore":286}],288:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.MultiContractKeyStore=void 0;class MultiContractKeyStore{}exports.MultiContractKeyStore=MultiContractKeyStore;
...
},{"./lib/browser-index":294,"buffer":75}],290:[function(require,module,exports){
...
},{"@near-js/accounts":268}],291:[function(require,module,exports){
...
},{"@near-js/accounts":268}],292:[function(require,module,exports){
...
},{"@near-js/accounts":268}],293:[function(require,module,exports){
...
},{"./near":303}],294:[function(require,module,exports){
...
},{"./browser-connect":293,"./common-index":295,"./key_stores/browser-index":298}],295:[function(require,module,exports){
...
},{"./account":290,"./account_creator":291,"./account_multisig":292,"./connection":296,"./contract":297,"./near":303,"./providers":305,"./signer":308,"./transaction":309,"./utils":313,"./utils/key_pair":314,"./validators":319,"./wallet-account":320}],296:[function(require,module,exports){
...
},{"@near-js/accounts":268}],297:[function(require,module,exports){
...
},{"@near-js/accounts":268}],298:[function(require,module,exports){
...
},{"./browser_local_storage_key_store":299,"./in_memory_key_store":300,"./keystore":301,"./merge_key_store":302}],299:[function(require,module,exports){
...
},{"@near-js/keystores-browser":282}],300:[function(require,module,exports){
...
},{"@near-js/keystores":285}],301:[function(require,module,exports){
...
},{"@near-js/keystores":285}],302:[function(require,module,exports){
...
},{"@near-js/keystores":285}],303:[function(require,module,exports){
...
},{"@near-js/wallet-account":361}],304:[function(require,module,exports){
...
},{"@near-js/providers":325}],305:[function(require,module,exports){
...
},{"./failover-rpc-provider":304,"./json-rpc-provider":306,"./provider":307}],306:[function(require,module,exports){
...
},{"@near-js/providers":325,"@near-js/types":342}],307:[function(require,module,exports){
...
},{"@near-js/providers":325,"@near-js/types":342,"@near-js/utils":353}],308:[function(require,module,exports){
...
},{"@near-js/signers":329}],309:[function(require,module,exports){
...
},{"@near-js/transactions":335}],310:[function(require,module,exports){
...
},{"@near-js/types":342}],311:[function(require,module,exports){
...
},{"@near-js/accounts":268,"@near-js/types":342,"@near-js/utils":353}],312:[function(require,module,exports){
...
},{"@near-js/utils":353}],313:[function(require,module,exports){
...
},{"./enums":310,"./errors":311,"./format":312,"./key_pair":314,"./logger":315,"./rpc_errors":316,"./serialize":317,"./web":318}],314:[function(require,module,exports){
...
},{"@near-js/crypto":275}],315:[function(require,module,exports){
...
},{"@near-js/utils":353}],316:[function(require,module,exports){
...
},{"@near-js/utils":353}],317:[function(require,module,exports){
...
},{"@near-js/utils":353,"borsh":39}],318:[function(require,module,exports){
...
},{"@near-js/providers":325}],319:[function(require,module,exports){
...
},{"@near-js/utils":353}],320:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.WalletConnection=exports.ConnectedWalletAccount=void 0;var wallet_account_1=require("@near-js/wallet-account");Object.defineProperty(exports,"ConnectedWalletAccount",{enumerable:!0,get:function(){return wallet_account_1.ConnectedWalletAccount}}),Object.defineProperty(exports,"WalletConnection",{enumerable:!0,get:function(){return wallet_account_1.WalletConnection}});

},{"@near-js/wallet-account":361}],321:[function(require,module,exports){
...
},{"./provider":327,"@near-js/types":342,"@near-js/utils":353}],323:[function(require,module,exports){
...
},{"http":245,"https":152,"node-fetch":72}],324:[function(require,module,exports){
(function (global){(function (){
...
},{"./exponential-backoff":321,"./fetch":323,"@near-js/types":342,"@near-js/utils":353,"http-errors":151}],325:[function(require,module,exports){
...
},{"./exponential-backoff":321,"./failover-rpc-provider":322,"./fetch_json":324,"./json-rpc-provider":326,"./provider":327}],326:[function(require,module,exports){
(function (Buffer){(function (){
...
},{"./exponential-backoff":321,"./fetch_json":324,"./provider":327,"@near-js/transactions":335,"@near-js/types":342,"@near-js/utils":353,"buffer":75}],327:[function(require,module,exports){
...
},{"./in_memory_signer":328,"./signer":330}],330:[function(require,module,exports){
...
},{"./actions":332,"buffer":75}],332:[function(require,module,exports){
...
},{"@near-js/types":342}],333:[function(require,module,exports){
...
},{"./schema":337}],334:[function(require,module,exports){
...
},{"./action_creators":331,"@near-js/types":342}],335:[function(require,module,exports){
...
},{"./action_creators":331,"./actions":332,"./create_transaction":333,"./delegate":334,"./schema":337,"./sign":338,"./signature":339}],336:[function(require,module,exports){
...
},{"./assignable":340,"./errors":341,"./provider":343}],343:[function(require,module,exports){
...
},{"./light_client":344,"./response":345}],344:[function(require,module,exports){
...
},{"../logger":355}],349:[function(require,module,exports){
...
},{"./errors":348,"./rpc_errors":351}],350:[function(require,module,exports){
module.exports={
    "schema": {
        "AccessKeyNotFound": {
...
},{"../format":352,"./error_messages.json":347,"./rpc_error_schema.json":350,"@near-js/types":342,"mustache":167}],352:[function(require,module,exports){
...
},{"bs58":73}],353:[function(require,module,exports){
...
},{"./constants":346,"./errors":349,"./format":352,"./logger":355,"./logging":357,"./provider":358,"./utils":359,"./validators":360}],354:[function(require,module,exports){
...
},{"./logger":356}],356:[function(require,module,exports){
(function (process){(function (){
...
},{"./console.logger":354,"_process":182}],357:[function(require,module,exports){
...
},{"./errors":349,"./logger":355}],358:[function(require,module,exports){
(function (Buffer){(function (){
...
},{"buffer":75}],359:[function(require,module,exports){
...
},{"./utils":359,"depd":89}],361:[function(require,module,exports){
...
},{"./near":362,"./wallet_account":363}],362:[function(require,module,exports){
